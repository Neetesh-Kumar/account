          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Admin <small>Booking Details</small></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Booking Details <small>All Data</small></h2>
                      ...
                      ?>
                        <tr>
                            <td><?php echo $booking_date;?></td>
                              <td><?php echo $cnno;?></td>
                              <td>Refer</td>
                              <td><?php echo $cong_name;?></td>
                              <td><?php echo $cons_districation;?></td>
                              <td><?php echo $dest_city;?></td>
                              <td>eefeff</td>
                              <td><?php echo $cong_cells;?></td>
                              <td><?php echo $weight;?></td>
                              <td><?php echo $service_type;?></td>
                              <td>
                              <a href="edit_booking.php?wid=<?php echo $add_id?>" class="text-orange" title="Edit"  style="text-decoration: none;"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                              <a href="view_booking.php?aid=<?php echo $add_id?>" class="text-orange" title="Info"  style="text-decoration: none;"><i class="fa fa-info" aria-hidden="true"></i></a>
                              </td>
                       </tr>
                              <?php
                       }
