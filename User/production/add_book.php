                            ...
                            <div class="x_panel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>User Id</label>
                                            <input type="text" name="add_password" id="add_password" class="form-control" value="<?php echo $add_password; ?>" readonly>
                                        </div>
                                    </div>
                                    </div>	
                                    <div class="col-md-6 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea class="form-control" name="cong_address" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="sel_consi" id="inlineRadio1" value="Domestic" checked="checked">
                                        <label class="form-check-label" for="inlineRadio1">Domestic</label>
                                        <input class="form-check-input" type="radio" name="sel_consi" id="inlineRadio2" value="International">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label>Remarks</label>
                                            <textarea class="form-control" name="consi_remarks" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="hidden">
                                    <div class="col-md-6 col-sm-12">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-4">
                                    <button id="send" type="submit" class="btn btn-success" name="login">Book Now</button>
